...
def render_home(df):
    ...
    st.markdown("\n".join([
        "<style>",
        ".home-card { background: linear-gradient(135deg, #f3e7d6 0%, #dfc8a8 100%); border: 2px solid #c8ac88; border-radius: 14px; padding: 18px 20px; height: 260px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.08); margin-bottom: 16px; }",
        ".home-card h3 { color: #3d2817; margin: 0 0 10px 0; font-size: 1.1rem; }",
        ".home-card p, .home-card li { color: #4a3627; font-size: 0.95rem; }",
    ...
    with row1_col2:
        st.markdown("\n".join([
            ...
            "<li><strong>Vente en l'etat futur d'achevement (VEFA)</strong> : achat sur plan d'un bien en construction</li>",
            "<li><strong>Adjudication</strong> : vente aux encheres publiques</li>",
            "<li><strong>Expropriation</strong> : acquisition forcee par une autorite publique</li>",
            "<li><strong>Vente de terrain a batir</strong> : vente d'un terrain nu destine a la construction</li>",
            "</ul>",
            "</div>",
        ]), unsafe_allow_html=True)
    ...
    with row2_col1:
        st.markdown("\n".join([
            ...
            "<ul>",
            "<li><strong>Valeur fonciere</strong> : prix de vente total du bien en euros</li>",
            "<li><strong>Prix au m2</strong> : prix de vente divise par la surface habitable</li>",
            "<li><strong>Surface reelle batie</strong> : surface habitable du bien en m2</li>",
            "<li><strong>Nombre de pieces</strong> : nombre de pieces principales (hors cuisine et salle de bain)</li>",
            "<li><strong>Arrondissement</strong> : division administrative de Paris (1er au 20eme)</li>",
            "</ul>",
            "</div>",
        ]), unsafe_allow_html=True)
    ...
    with row2_col2:
        st.markdown("\n".join([
            ...
            "<p>Les donnees proviennent de la base <strong>Demandes de Valeurs Foncieres (DVF)</strong> publiee par la Direction Generale des Finances Publiques (DGFiP).</p>",
            "<p>Les donnees cadastrales des batiments proviennent du <strong>cadastre Etalab</strong> et de la <strong>Base de Donnees Nationale des Batiments (BDNB)</strong>.</p>",
            "</div>",
        ]), unsafe_allow_html=True)
