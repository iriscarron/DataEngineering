    ...
    with col2:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #2563eb 0%, #3b82f6 100%);
                ...
                <div style='font-size: 2.2rem; font-weight: 800; color: white;'>{prix_moyen/1e6:.2f}M€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col3:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);
                ...
                <div style='font-size: 2.2rem; font-weight: 800; color: white;'>{prix_m2_median:,.0f}€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col4:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0284c7 0%, #0369a1 100%);
                ...
                <div style='font-size: 2.2rem; font-weight: 800; color: white;'>{surface_moyenne:.0f}m²</div>
            </div>
            """,
            unsafe_allow_html=True
        )
...
def graphique_evolution_prix(df):
    ...
    fig.update_traces(
        ...
        marker=dict(size=8, color=PRIMARY_COLOR, line=dict(width=2, color='white')),
...
def graphique_prix_m2(df):
    ...
    fig.update_traces(
        marker=dict(opacity=0.6, size=3),
        line=dict(width=2)
    )
    return styliser_fig(fig)
...
def render_home(df, filters):
        ...
        <div style='background: linear-gradient(135deg, #0c4a6e 0%, #0369a1 50%, #0ea5e9 100%);
            ...
            <div style='margin-top: 1.5rem;'>
                <span style='background: rgba(255,255,255,0.2); padding: 0.5rem 1rem; 
                            border-radius: 20px; color: white; font-size: 0.9rem; margin: 0 0.5rem;'>
                    API DVF+ Cerema
                </span>
                <span style='background: rgba(255,255,255,0.2); padding: 0.5rem 1rem; 
                            border-radius: 20px; color: white; font-size: 0.9rem; margin: 0 0.5rem;'>
    ...
    with col1:
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0f2f4f 0%, #1a3a52 100%);
                ...
                <div style='color: #0ea5e9; font-weight: 800; font-size: 1.3rem; margin-bottom: 0.3rem;'>Transactions</div>
    ...
    with col2:
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0f2f4f 0%, #1a3a52 100%);
                ...
                <div style='color: #0ea5e9; font-weight: 800; font-size: 1.3rem; margin-bottom: 0.3rem;'>Analyse Prix</div>
                <div style='color: #94a3b8; font-size: 0.85rem; margin-top: 0.5rem;'>
    ...
    with col3:
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0f2f4f 0%, #1a3a52 100%);
                ...
                <div style='color: #0ea5e9; font-weight: 800; font-size: 1.3rem; margin-bottom: 0.3rem;'>Carte Interactive</div>
                <div style='color: #94a3b8; font-size: 0.85rem; margin-top: 0.5rem;'>
    ...
    with col4:
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0f2f4f 0%, #1a3a52 100%);
                ...
                <div style='color: #0ea5e9; font-weight: 800; font-size: 1.3rem; margin-bottom: 0.3rem;'>Recherche IA</div>
                <div style='color: #94a3b8; font-size: 0.85rem; margin-top: 0.5rem;'>
    ...
    st.markdown(
        ...
        <div style='background: linear-gradient(90deg, #0f2f4f 0%, #1a3a52 100%);
            ...
            <div style='color: #0ea5e9; font-weight: 700; font-size: 1.2rem; margin-bottom: 1rem;'> Guide rapide</div>
            <div style='color: #cbd5e1;'>
                <div style='margin-bottom: 0.5rem;'> <strong>Navigation:</strong> Utilisez les onglets ci-dessus pour explorer les différentes vues</div>
                <div style='margin-bottom: 0.5rem;'> <strong>Filtres:</strong> Sidebar à gauche pour affiner par date, arrondissement, type et prix</div>
                <div style='margin-bottom: 0.5rem;'> <strong>Recherche:</strong> Trouvez des transactions spécifiques avec le moteur Elasticsearch</div>
                <div> <strong>Visualisations:</strong> 7 graphiques interactifs + cartes géolocalisées</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True
    ...
    with col_k1:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #059669 0%, #10b981 100%);
                ...
                <div style='font-size: 1.5rem; font-weight: 700; color: white;'>{prix_min/1e6:.2f}M€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col_k2:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #0891b2 0%, #06b6d4 100%);
                ...
                <div style='font-size: 1.5rem; font-weight: 700; color: white;'>{prix_q1/1e6:.2f}M€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col_k3:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #2563eb 0%, #3b82f6 100%);
                ...
                <div style='font-size: 1.5rem; font-weight: 700; color: white;'>{prix_q3/1e6:.2f}M€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col_k4:
        ...
        st.markdown(
            ...
            <div style='background: linear-gradient(135deg, #6d28d9 0%, #8b5cf6 100%);
                ...
                <div style='font-size: 1.5rem; font-weight: 700; color: white;'>{prix_max/1e6:.2f}M€</div>
            </div>
            """,
            unsafe_allow_html=True
        )
