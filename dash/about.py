...
def render_about():
    """Affiche la page À propos avec infos projet, stack technique et équipe."""
    st.markdown(
        """
    ...
    st.markdown(
        ...
        <div style='background: linear-gradient(135deg, #0f2f4f 0%, #1a3a52 100%);
            ...
            <p style='color: #e0f2fe; font-size: 1.15rem; line-height: 1.8;'>
                ...
                construit avec <strong>Streamlit</strong>
                pour explorer les transactions immobilières
                à Paris basé sur les données <strong>DVF+</strong>
                (Demandes de Valeurs Foncières) du Cerema.
            </p>
        </div>
        """,
        unsafe_allow_html=True
    ...
    with col1:
        st.markdown(
            ...
            <div style='background: #0f2f4f; padding: 1.5rem; border-radius: 10px;
                ...
                <div style=
                'color: #0ea5e9; font-weight: 700; font-size: 1.1rem; margin-bottom: 1rem;'
                > Backend</div>
    ...
    with col2:
        st.markdown(
            ...
            <div style='background: #0f2f4f; padding: 1.5rem; border-radius: 10px;
                ...
                <div style=
                'color: #06b6d4; font-weight: 700; font-size: 1.1rem; margin-bottom: 1rem;'
                > Frontend</div>
                <div style='color: #cbd5e1; line-height: 2;'>
    ...
    features = [
        ("•", "7 types de visualisations",
         "Timeline, prix par arrondissement, distribution, boxplot, pie chart..."),
        ("•", "Cartes interactives",
         "Carte choroplèthe et points géolocalisés avec Mapbox"),
        ("•", "Recherche Elasticsearch",
         "Moteur de recherche intelligent avec fuzzy matching"),
        ("•", "Filtres avancés",
         "Date, arrondissement, type de bien, nature de vente, prix"),
        ("•", "Scraping automatique",
         "Pipeline ETL automatisé au lancement avec retry"),
        ...
        with col:
            st.markdown(
                ...
                <div style='background: #0f2f4f; padding: 1rem; border-radius: 8px;
                    ...
                    <div style='color: #0ea5e9; font-weight: 700;\n                            font-size: 1rem;'>
                        {marker} {titre}
                    </div>
        ...
        <div style='background: linear-gradient(90deg, #0f2f4f 0%, #1a3a52 100%);
            ...
            <div style='color: #e0f2fe; line-height: 1.8;'>
                <strong style='color: #06b6d4;'>API DVF+ du Cerema</strong><br>
                 <a href='https://datafoncier.cerema.fr' target='_blank' style='color: #0ea5e9;
                 '>https://datafoncier.cerema.fr</a><br>
    ...
    st.markdown(
        ...
        <div style='text-align: center; padding: 2rem; background: #0f2f4f;
            ...
            <div style='color: #0ea5e9; font-size: 1.3rem;\n
